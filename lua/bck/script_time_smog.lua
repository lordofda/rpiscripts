...
if (time.min % 10  == 0) then
	...
	local extractedCO = jsonCO.values[2].value
	local extractedPM10 = jsonPM10.values[2].value
	local extractedNO2 = jsonNO2.values[2].value
	local extractedSO2 = jsonSO2.values[2].value
